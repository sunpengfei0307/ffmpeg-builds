...
#define FFMPEG_CONFIGURATION "--prefix=/data/sunpf/ffmpeg-builds/build/release --pkg-config-flags=--static --pkg-config=pkg-config --arch=x86_64 --target-os=linux --enable-gpl --enable-version3 --enable-nonfree --disable-debug --enable-iconv --enable-zlib --enable-libfribidi --enable-gmp --enable-libxml2 --enable-openssl --enable-lzma --enable-libvorbis --enable-opencl --enable-libpulse --enable-libvmaf --enable-amf --enable-libaom --enable-avisynth --enable-chromaprint --enable-libdav1d --enable-libdavs2 --enable-libfdk-aac --enable-ffnvcodec --enable-cuda-llvm --enable-frei0r --enable-libgme --enable-libkvazaar --enable-liblcevc-dec --enable-libaribcaption --enable-libass --enable-libbluray --enable-libmp3lame --enable-libopus --enable-libplacebo --enable-libssh --enable-libtheora --enable-libvpx --enable-libwebp --enable-libzmq --enable-libvpl --enable-openal --enable-liboapv --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libopenh264 --enable-libopenjpeg --enable-libopenmpt --enable-librav1e --enable-librubberband --disable-schannel --enable-sdl2 --enable-libsnappy --enable-libsoxr --enable-libsrt --enable-libsvtav1 --enable-libtwolame --enable-libuavs3d --enable-libvidstab --enable-libvvenc --disable-whisper --enable-libx264 --enable-libx265 --enable-libxavs2 --enable-libxvid --enable-libzimg --enable-libzvbi --enable-fontconfig --enable-libharfbuzz --enable-libfreetype --enable-libxcb --enable-xlib --enable-vulkan --enable-libshaderc --enable-libaribb24 --enable-libdvdread --enable-libdvdnav --enable-libjxl --enable-librist --enable-lv2 --enable-libdrm --enable-vaapi --extra-cflags='-DCL_TARGET_OPENCL_VERSION=120 -DLIBTWOLAME_STATIC -static-libgcc -static-libstdc++ -I/data/sunpf/ffmpeg-builds/build/release/include -O2 -pipe -fPIC -DPIC -pthread -Wno-unused-function -Wno-stack-usage -Wno-format-truncation -Wno-main -Wno-deprecated-declarations -Wno-redundant-decls' --extra-cxxflags=' -static-libgcc -static-libstdc++ -I/data/sunpf/ffmpeg-builds/build/release/include -O2 -pipe -fPIC -DPIC -pthread -Wno-unused-function -Wno-stack-usage -Wno-format-truncation -Wno-main -Wno-deprecated-declarations -Wno-redundant-decls' --extra-libs='-lgomp -ldl' --extra-ldflags='-pthread -static-libgcc -static-libstdc++ -L/data/sunpf/ffmpeg-builds/build/release/lib -pthread -lm' --extra-ldexeflags=-pie --cc=x86_64-redhat-linux-gcc --cxx=x86_64-redhat-linux-g++ --ar=x86_64-redhat-linux-gcc-ar --ranlib=x86_64-redhat-linux-gcc-ranlib --nm=x86_64-redhat-linux-gcc-nm --extra-version=20260907"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR "/data/sunpf/ffmpeg-builds/build/release/share/ffmpeg"
#define AVCONV_DATADIR "/data/sunpf/ffmpeg-builds/build/release/share/ffmpeg"
